...
internal sealed record TimerTickedEvent(Job Job) : OrchestratorEvent;
...
internal sealed record StageCompletedEvent(Job Job) : OrchestratorEvent;

/// <summary>Итерация инстанса завершилась неуспехом (исключение или watchdog cancel).</summary>
internal sealed record StageFailedEvent(Job Job, Exception Exception) : OrchestratorEvent;
